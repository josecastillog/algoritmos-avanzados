...
nodeTrie *nodeTrie::getChild(char c) { return child[c - 'a']; }

void nodeTrie::setChild(nodeTrie *ptrChild) {
  child[ptrChild->letter - 'a'] = ptrChild;
}

bool nodeTrie::getIsLeaf() { return isLeaf; }

char nodeTrie::getLetter() { return letter; }

void nodeTrie::setIsLeaf(bool value) { isLeaf = value; }
